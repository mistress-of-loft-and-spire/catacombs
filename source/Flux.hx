...
class Flux extends FlxSprite
{
	...
	override function drawComplex(camera:FlxCamera):Void 
	{
		...
		{
			_frameGraphic = FlxGraphic.fromAssetKey("assets/images/test.png", false, null, false);
		...
		camera.drawTriangles(_frameGraphic, _vertices, _indices, _uvtData, colors, new FlxPoint(10, 10), blend, antialiasing);
		trace(_vertices);
	}
	...
	{//calc vert positions/angles/phys
		_vertices = new DrawData();
